...
class Aboutus extends Component
{
    ...
    render()
    {
        ...
        {
            return (<Card title={"Corporate Leadership"}>
                        <Loading/>
                    </Card>
                    );
        }
                ...
                <ScrollView>
                    <Card title={'Our History'}>
                        <Text>
                            ...
                            our CEO, Mr. Peter Pan,
                            that featured for the first time the world's best cuisines in a pan.
                        </Text>
                    </Card>
                    <Card title={"Corporate Leadership"}>
                        <FlatList data={this.props.leaders.leaders} renderItem={renderLeaderItem}
